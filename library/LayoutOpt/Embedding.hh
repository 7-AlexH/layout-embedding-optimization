...
void compute_layout_embedding_init(TargetMeshData const& _tmd, LayoutData& _ld, PathNetworkData& _pnd, OverlayMeshData& _omd, bool _allow_fallback_for_stability = false);
